...
class WineRecommenderNN(nn.Module):
    ...
    def train_model(self, features, epochs=50, batch_size=128, learning_rate=0.001, verbose=True):
        """
    ...
    def load_model(self, filepath):
        ...
        if (model_data['input_dim'] != self.input_dim or
            model_data['hidden_dim'] != self.hidden_dim or
...
if __name__ == "__main__":
    ...
    model = WineRecommenderNN(input_dim=input_dim, hidden_dim=128, output_dim=64)
    ...
    model2 = WineRecommenderNN(input_dim=input_dim, hidden_dim=128, output_dim=64)
